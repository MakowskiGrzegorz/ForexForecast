...
def technical_objective(params):
    ...
    technical_dataset_train, technical_dataset_valid = loader.prepare_technical_data(window_size=params['window_size'], overlap=params['overlap'])
...
def fundamental_objective(params):
    ...
    loader = DataLoader('data/EURUSD240_technical.csv', "data/fundamental_data.csv")
    fundamental_dataset_train, fundamental_dataset_valid = loader.prepare_fundamental_data(window_size=params['window_size'], overlap=params['overlap'])
...
def combined_objective(params):
    ...
    loader = DataLoader('data/EURUSD240_technical.csv', "data/fundamental_data.csv")
    combined_dataset_train, combined_dataset_valid = loader.prepare_combined_data(window_size=params['window_size'], overlap=params['overlap'])
